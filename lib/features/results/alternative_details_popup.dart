      ...
      return Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              // Show a soft warning if pricing could not be fetched
              if (_finalProposal!.storeLocation == null &&
                  _finalProposal!.pricingFailure != null)
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            _finalProposal!.pricingFailure!.userMessage,
                            style: TextStyle(
                              fontSize: 13,
